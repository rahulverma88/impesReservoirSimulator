...
del_xd = del_x(1,1)/Nx;
del_td = factor*del_xd;
Vp_tot = sum(sum(Vp));


disp('This is part 2 of the project. The "factor" taken as input is multiplied by del_Xd to get del_td. Different cases can be obtained by changing this factor')
disp('Well inputs and geometry are fixed, and can be modified within the code')
...
%time_step = del_td*Vp_tot/q1(1,1);
del_t = del_td*Vp_tot/q1(1,1);%24*60*60*time_step;
t_max=0.5*Vp_tot/q1(1,1);%2246400;
steps = t_max/del_t;
